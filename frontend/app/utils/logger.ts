// Centralized client-side logging chokepoint for the marketing / auth frontend.
//
// WHY: defensive catch-blocks and dev guards used to call console.* directly,
// which dumped noise into the browser DevTools console (and, in one case, a raw
// Google credential) on real user sessions. Routing everything through here gives
// us ONE place to:
...
//
// Auto-imported like the layer's other utils (app/utils is in Nuxt's auto-import
// scan) — no import statement needed at call sites.
